...
function preload(){
 ...
 // sun_Animation = loadAnimation("Sun1.png","sun2.png")
...
function setup() {
 ...
 // sun.createSprite(50,160,100,50);
 //sun.addAnimation("rolling",sun_Animation)
...
function draw() {
  ...
  text("enemy points: "+ enemyPoints,300,50)
  ...
  if(gameState === PLAY){
    ...
    if(keyDown("space")&& trex.y >= 130) {  //used to be 100 for trex.y >= 100
        trex.velocityY = -12;
        jumpSound.play();
    }
    if (keyDown("A")){
